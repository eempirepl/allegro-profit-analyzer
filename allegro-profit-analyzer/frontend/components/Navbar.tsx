      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            <Link href="/api-settings" className="text-gray-700 hover:text-primary px-3 py-2 rounded-md">
              Ustawienia API
            </Link>
      ...
      {isMenuOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <Link href="/api-settings" className="block text-gray-700 hover:text-primary px-3 py-2 rounded-md">
              Ustawienia API
            </Link>
