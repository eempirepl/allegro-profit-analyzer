...
exports.syncController = {
    ...
    async syncProducts(req, res) {
        try {
            ...
            const result = await dataSyncService_1.dataSyncService.syncProducts();
    ...
    async syncOrders(req, res) {
        try {
            ...
            // Wykonujemy synchronizację
            const result = await dataSyncService_1.dataSyncService.syncOrders(dateFrom, dateTo);
            // Informujemy o zakończeniu synchronizacji
            res.write(`data: ${JSON.stringify({
                status: 'complete',
    ...
    async syncAll(req, res) {
        try {
            ...
            // Wykonujemy synchronizację
            const result = await dataSyncService_1.dataSyncService.syncAll(dateFrom, dateTo);
            // Informujemy o zakończeniu synchronizacji
            res.write(`data: ${JSON.stringify({
                status: 'complete',
